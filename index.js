...
// 🏡 Task 3: Function
/* Create a function called `mortgageCalculator` that combines all of the steps from task 1 and 2 and returns a sentence
"{Name}, your monthly rate is ${monthlyRate}"
...
// function mortgageCalculator (principal, interestRate, years, name) {
//   const monthlyInterestRate = (interestRate / 12)
//   const periods = (years * 12)
...
// mortgageCalculator(200000, 0.05, 30, 'Chris')
...
//   if (creditScore > 740) {
//     console.log(name + ' your monthly rate is ' + (monthlyRate * 0.95))
//   } else if (creditScore < 660) {
//     console.log(name + ' your monthly rate is ' + (monthlyRate * 1.05))
//   } else {
//     console.log(name + ' your monthly rate is ' + monthlyRate)
//   }
// }

// mortgageCalculator(200000, 0.05, 30, 'Chris', 700)
